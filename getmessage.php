...
<div class="mb-4 px-3">
    ...
    <div class="message">
        ...
        ?>
                        <div class="card">
                            <a href="academic_letter_inbox_opener.php?id=<?php echo $row['id']; ?>" class="list-group-item-action stretched-link">
                    ...
                    ?>
                        ...
                        <div class="card">
                            <a href="commented_academic_letter_inbox_opener.php?id=<?php echo $row['id']; ?>" class="list-group-item-action stretched-link">
                                <div class="card-body p-3">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><?php echo $row['sender']; ?></div>
