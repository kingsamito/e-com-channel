...
if(isset($_POST["sendmessage"])){
    ...
    if($toErr == '' && $throughErr == '' && $blockErr =='' && $roomErr == '' && $hostelErr == '' && $subjectErr == '' && $messageErr == '' && $parentErr == '') {
        $sql = "INSERT INTO `exeat_inbox`(`sender`, `matric`, `to`, `through`, `block`, `room`, `hostel`, `subject`, `message`, `parentnumber`) VALUES('$sender', '$matric' , '$to', '$through','$block','$room','$hostel','$subject','$message','$parent')";
        $sql1 = "INSERT INTO `student_exeat_sent`(`sender`, `matric`, `to`, `through`, `block`, `room`, `hostel`, `subject`, `message`, `parentnumber`) VALUES('$sender', '$matric' , '$to', '$through','$block','$room','$hostel','$subject','$message','$parent')";
...
<body>
	<div class="row mt-4">
		...
		<div class="form-group" style="width:50%">
			...
			<input type="text" class="form-control" id="through" name="through" value="Hall Master" disabled><span><?php echo $throughErr; ?></span>
		</div>
		<div class="clearfix">
