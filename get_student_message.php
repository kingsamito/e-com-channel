...
<div class="msgs">
    ...
    <div class="message">
        ...
        ?>
                        <div class="card">
                            <a href="commented1_exeat_letter_inbox_opener.php?id=<?php echo $row['id']; ?>" class="list-group-item-action stretched-link">
                    ...
                    ?>
                        ...
                        <div class="card">
                            <a href="commented1_other_letter_inbox_opener.php?id=<?php echo $row['id']; ?>" class="list-group-item-action stretched-link">
                                <div class="card-body p-3">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><?php echo $row['sender']; ?></div>
                ...
                } elseif ($row['type'] == 'commented_academic') {
                    if ($row['status'] == '') {
                    ?>

                        <div class="card">
                            <a href="commented1_academic_letter_inbox_opener.php?id=<?php echo $row['id']; ?>" class="list-group-item-action stretched-link">
                                <div class="card-body p-3">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><?php echo $row['sender']; ?></div>
                    ...
                    if (!preg_match("/$matric/i",$row['status'])) {
                    ?>

                        <div class="card">
                            <a href="memoinboxopener.php?id=<?php echo $row['id']; ?>" class="list-group-item-action stretched-link">
                                <div class="card-body p-3">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><?php echo $row['sender']; ?></div>
