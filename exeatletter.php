...
if (isset($_POST["sendmessage"])) {
    ...
    if ($toErr == '' && $throughErr == '' && $blockErr == '' && $roomErr == '' && $hostelErr == '' && $subjectErr == '' && $messageErr == '' && $parentErr == '') {
        ...
        VALUES('$sender', '$matric' , '$to', '$through','$block','$room','$hostel','$subject','$message','$parent','$message_date','exeat','')";
    ...
    <div class="container">
        ...
        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" id="messageform">
            ...
            <div class="form-group" style="width:50%">
                ...
                <input type="text" class="form-control" id="through" name="through" value="<?php echo $through; ?>" disabled><span><?php echo $throughErr; ?></span>
            </div>
