...
$lnameErr = $fnameErr = $positionErr = $departmentErr = $collegeErr = $genderErr  = $passErr =  '';
...
if(isset($_POST["create"])){
    ...
    if($lnameErr == '' && $fnameErr == '' && $positionErr =='' && $departmentErr =='' && $collegeErr =='' && $genderErr =='' && $passErr == '') {
        $sql = "INSERT INTO `academic_staff`(`Lastname`, `Firstname`, `Position`, `Department`, `College`, `Gender`, `password`) 
        VALUES ('$lname','$fname','$position','$department','$college','$gender','$password')";
        $result = mysqli_query($conn,$sql);
        if($result) {
