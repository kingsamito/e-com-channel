    ...
    <div class="message">
        ...
        if (mysqli_num_rows($sentresult) > 0) {
            while ($row = mysqli_fetch_assoc($sentresult)) {
                ...
                ?>
                <div class="card">
                    <a href="commented_exeat_letter_sent_opener.php?id=<?php echo $row['id']; ?>" class="list-group-item-action stretched-link">
        ...
        <?php
                    ...
                    ?>
                    <div class="card">
                    <a href="commented_other_letter_sent_opener.php?id=<?php echo $row['id']; ?>" class="list-group-item-action stretched-link">
                        <div class="card-body p-3">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><?php echo $row['too']; ?></div>
