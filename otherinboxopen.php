...
$readsql = "UPDATE `other_letter_inbox` SET `status`='read' WHERE `id` = $id";
...
if (isset($_POST["submit"])) {
	...
	if ($comentErr == '') {
        ...
        VALUES('$id','$user','$sender', '$id_no' , '$to', '$through','$office','$room','$hostel','$subject','$message','$message_date','commented_other_letter','$comento','$joincomment','')";
...
<body>
	...
	<div class="memo-main-container">
		...
		?><br><br><br><br>
				...
				<form method="POST" action="<?php echo htmlspecialchars('otherinboxopen.php?id=' . $id); ?>">
					<?php
