...
$sql1 = "SELECT * FROM commented_exeat_inbox WHERE id = '$id'";
...
if (isset($_POST["submit"])) {
    ...
    if ($comentErr == '') {
        ...
        VALUES('$id','$user','$sender', '$id_no' , '$to', '$through','$office','$room','$hostel','$subject','$message','$parent','$message_date','commented_exeat','$comento','$joincomment','')";
