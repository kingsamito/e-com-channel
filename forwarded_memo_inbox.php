...
$id = $_GET['id'];
$sql = "SELECT * FROM forwarded_memo_inbox WHERE id=$id";
    ...
    <div class="memo-main-container">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="" method="POST">
                        <!-- <input type="text" class="form-control" id="from" readonly name="from" hidden value="<?php echo $sender; ?>">
                        <input type="text" class="form-control" id="ref" readonly name="ref" hidden value="<?php echo $ref; ?>">
                        <input type="text" class="form-control" id="date" readonly name="datee" hidden value="<?php echo $message_date; ?>"> -->
                        <input type="text" class="form-control" id="recipient" readonly name="recipient" hidden value="<?php echo $recipient; ?>">
                        <!-- <input type="text" class="form-control text-center" id="subject" readonly name="subject" hidden value="<?php echo $subject; ?>">
                        <input type="text" class="form-control" id="message" readonly name="message" hidden value="<?php echo $message; ?>"> -->
        ...
        <div class="header row my-4">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <p>Forwarded By: <?php echo $forwarded_by ?></p>
                </div>
                <div class="form-group">
                    <p>Forwarded To: <?php echo $forwarded_to ?></p>
                </div>
            </div>
        </div>
        <div class="content">
